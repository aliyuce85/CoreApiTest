    ...
    public class ConsumerManager : IConsumerService
    {
        ...
        public async Task Start()
        {
            try
            {
                ...
                _channel.QueueDeclare(queue: "EmailQuee",
                                     durable: true,
                                     exclusive: false,
                                     autoDelete: false,
                                     arguments: null);
                ...
                await Task.FromResult(_channel.BasicConsume(queue: "EmailQuee",
                                           autoAck: false,
        ...
        private void Consumer_Received(object sender, BasicDeliverEventArgs ea)
        {
            try
            {
                ...
                MailMessageData message = _objectConvertFormat.JsonToObject<MailMessageData>(Encoding.UTF8.GetString(ea.Body.ToArray()));
